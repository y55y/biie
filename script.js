...
const translations = {
  ar: {
    title: "BIIE New York | الشريك الخليجي",
    description: "صفحة BIIE New York للشريك الخليجي. تسوقي مكياج BIIE للشفاه والوجه والعيون والأظافر عبر ذا أورا بيوتي في السعودية.",
    selectors: [
      ...
      [".hero-actions .primary", "تسوقي BIIE من ذا أورا بيوتي"],
      ...
      [".intro-grid p", "هذه الصفحة الخليجية تقرب BIIE من المنتج: الدرجة، اللمسة النهائية، الملمس، ومكان الشراء. ليست بديلا للكتالوج، بل مساحة العلامة قبل المتجر الرسمي."],
      [".collection .section-lead .eyebrow", "المجموعة"],
      [".collection .section-lead p:last-child", "ابدئي من اللمسة النهائية: بشرة منتعشة، لون مصقول، تحديد للرموش، ولمعة أظافر في اختيار واحد من BIIE."],
      ["#collection-title", "خمس طقوس جمال، ولمسة BIIE واحدة."],
      ...
      [".bestseller-copy p", "قصة الشفاه لدى BIIE مباشرة: لون واضح، لمسة نظيفة، وخزانة درجات تنتقل من الوردي اليومي الدافئ إلى التوتي العميق للمساء."],
      [".text-link", "شاهدي منتجات BIIE لدى ذا أورا بيوتي"],
      ...
      [".gulf-copy p", "تتوقع المتسوقة الخليجية مكياجا يظهر جميلا في الصور، يحمل اللون بوضوح، ويبقى أنيقا عن قرب. تمنح مجموعة BIIE موقع الشريك وعدا بسيطا: اختاري اللمسة النهائية، ثم اشتري عبر المسار المحلي."],
      [".gulf-points div:nth-child(1) h3", "مسار شراء مباشر"],
      [".gulf-points div:nth-child(1) p", "كل قسم رئيسي يقود إلى صفحة BIIE الرسمية لدى ذا أورا بيوتي."],
      ...
      [".gulf-points div:nth-child(3) p", "صور بطابع BIIE الحقيقي تحمل الصفحة بدلا من زخارف جمال عامة."],
      ...
      ["#store-title", "من اكتشاف BIIE إلى الدفع عبر ذا أورا بيوتي."],
      [".store-panel p", "لتوفر المنتجات، تصفح الدرجات، والشراء أونلاين، استخدمي صفحة BIIE New York الرسمية لدى ذا أورا بيوتي."],
      [".store-actions .primary", "افتحي متجر BIIE"],
      [".store-actions .secondary", "راسلينا info@biiesa.com"],
      [".mobile-shop-bar a:nth-child(1)", "تسوقي BIIE"],
      ...
      [".site-footer div:nth-child(2) a:nth-child(2)", "موقع BIIE الأصلي"],
    ...
    attrs: [
      ...
      [".trust-bar", "aria-label", "تفاصيل شريك BIIE"],
...
translations.ar = {
  ...
  selectors: [
    ...
    [".hero-text", "مكياج BIIE يمنحك لونا واضحا، بشرة مرتبة، عيونا محددة، ولمسة أظافر أنيقة. متوفر في السعودية والخليج عبر ذا أورا بيوتي."],
    [".hero-actions .primary", "تسوقي BIIE من ذا أورا بيوتي"],
    ...
    [".intro-grid p", "هذه الصفحة تعرفك على منتجات BIIE بطريقة مباشرة: اللون، اللمسة، الاستخدام، ومكان الشراء. اختاري ما يناسبك ثم انتقلي للمتجر الرسمي لدى ذا أورا بيوتي."],
    [".collection .section-lead .eyebrow", "المجموعة"],
    [".collection .section-lead p:last-child", "ابدئي من النتيجة التي تحبينها: بشرة ناعمة، لون شفاه واضح، عيون محددة، وأظافر لامعة في مجموعة واحدة من BIIE."],
    ["#collection-title", "خمس لمسات جمال، ونتيجة واحدة أنيقة من BIIE."],
    [".category-card.feature:not(.feature-secondary) span", "بوتوكس"],
    ...
    [".bestseller-copy p", "منتجات الشفاه من BIIE تمنحك لونا واضحا ولمسة نظيفة، بدرجات تناسب الإطلالة اليومية والمساء."],
    [".text-link", "شاهدي منتجات BIIE لدى ذا أورا بيوتي"],
    [".gulf-copy .eyebrow", "لروتين الجمال الخليجي"],
    ["#gulf-title", "إطلالة مرتبة تناسب الأيام الساطعة، العزائم، وإضاءة المناسبات."],
    [".gulf-copy p", "في الخليج نحتاج مكياجا يظهر جميلا في الصور، يحمل اللون بوضوح، ويبقى أنيقا عن قرب. BIIE تسهل عليك الاختيار: حددي اللمسة التي تريدينها، ثم اشتري عبر المتجر المحلي."],
    [".gulf-points div:nth-child(1) h3", "شراء واضح ومباشر"],
    [".gulf-points div:nth-child(1) p", "كل قسم رئيسي يوصلك إلى صفحة BIIE الرسمية لدى ذا أورا بيوتي."],
    [".gulf-points div:nth-child(2) h3", "تواصل محلي"],
    ...
    [".gulf-points div:nth-child(3) p", "الصور تركز على ألوان BIIE وملمسها، بعيدا عن الصور العامة والمبالغ فيها."],
    [".looks .section-heading .eyebrow", "دليل الإطلالات"],
    ...
    [".look-card:nth-child(3) p", "بشرة موحدة، رموش محددة، قلوس، وطلاء أظافر."],
    [".store-panel .eyebrow", "تسوقي في السعودية"],
    ["#store-title", "من التعرف على BIIE إلى الشراء من ذا أورا بيوتي."],
    [".store-panel p", "للتأكد من توفر المنتجات وتصفح الدرجات والشراء أونلاين، استخدمي صفحة BIIE New York الرسمية لدى ذا أورا بيوتي."],
    [".store-actions .primary", "افتحي متجر BIIE"],
    [".store-actions .secondary", "راسلينا info@biiesa.com"],
    [".mobile-shop-bar a:nth-child(1)", "تسوقي BIIE"],
    [".mobile-shop-bar a:nth-child(2)", "واتساب"],
...
translations.ar = {
  title: "BIIE New York | الشريك الخليجي",
  description: "صفحة BIIE New York الرسمية للشريك الخليجي. اكتشفي منتجات BIIE للشفاه والوجه والعيون والأظافر، وتسوقيها عبر ذا أورا بيوتي في السعودية.",
  selectors: [
    [".skip-link", "تخطي إلى المحتوى"],
    [".site-nav a:nth-child(1)", "المجموعة"],
    [".site-nav a:nth-child(2)", "الأكثر طلبا"],
    ...
    [".hero-copy .eyebrow", "الشريك الرسمي في الخليج"],
    [".hero-line", "ألوان نيويورك بثبات يناسب أجواء الخليج."],
    [".hero-text", "اكتشفي منتجات BIIE للشفاه والوجه والعيون والأظافر: ألوان واضحة، تغطية ناعمة، تحديد مرتب، ولمسات نهائية تناسب يومك ومناسباتك."],
    [".hero-actions .primary", "تسوقي BIIE من ذا أورا بيوتي"],
    [".hero-actions .secondary", "تواصلي عبر واتساب"],
    [".hero-note span:first-child", "لأنك تهميننا"],
    [".hero-note span:last-child", "وجه · شفاه · عيون · أظافر"],
    ...
    [".intro-grid p", "هذه الصفحة تعرفك على منتجات BIIE بطريقة مباشرة: الدرجات، التغطية، اللمسة النهائية، ومكان الشراء. اختاري ما يناسب إطلالتك، ثم انتقلي إلى المتجر الرسمي لدى ذا أورا بيوتي."],
    [".collection .section-lead .eyebrow", "المجموعة"],
    [".collection .section-lead p:last-child", "ابدئي من النتيجة التي تحبينها: بشرة موحدة، لون شفاه واضح، عيون محددة، وأظافر لامعة ضمن مجموعة واحدة من BIIE."],
    ["#collection-title", "خمس لمسات مكياج، ونتيجة أنيقة من BIIE."],
    [".category-card.feature:not(.feature-secondary) span", "بوتوكس"],
    [".category-card.feature:not(.feature-secondary) h3", "مظهر منتعش ولمسة مصقولة"],
    ...
    [".bestseller-copy p", "منتجات الشفاه من BIIE تمنحك لونا واضحا ولمسة نهائية أنيقة، بدرجات تناسب إطلالات النهار والمساء."],
    [".text-link", "شاهدي منتجات BIIE لدى ذا أورا بيوتي"],
    [".gulf-copy .eyebrow", "لروتين الجمال الخليجي"],
    ["#gulf-title", "إطلالة مرتبة تناسب الأيام الساطعة، العزائم، وإضاءة المناسبات."],
    [".gulf-copy p", "في الخليج نحتاج مكياجا يظهر جميلا في الصور، يثبت لونه بوضوح، ويبقى أنيقا عن قرب. مع BIIE اختاري اللمسة التي تريدينها، ثم اشتري بسهولة عبر المتجر المحلي."],
    [".gulf-points div:nth-child(1) h3", "شراء واضح ومباشر"],
    [".gulf-points div:nth-child(1) p", "كل قسم رئيسي يوصلك إلى صفحة BIIE الرسمية لدى ذا أورا بيوتي."],
    [".gulf-points div:nth-child(2) h3", "تواصل محلي"],
